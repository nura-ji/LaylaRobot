...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Kazui_ka_Nura_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="layla_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/spam_aka"
        ),
    ],
    [
...
Powered by :- [Awesome Bots](t.me/spam_aka)"""

layla_IMG = "https://telegra.ph/file/fc765298cc0faf2288523.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Yokai](t.me/Nura) \
 Supporting isnt always financial! [AwesomeSupport](t.me/spam_aka) \
